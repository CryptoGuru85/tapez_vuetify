<template>
  <v-container>
    <statistics-provider v-slot="statistics" :from="range.from" :to="range.to">
      <div>
        <v-row>
          <v-col cols="auto">
            <h1>
    ...
    <v-row>
      <v-col cols="12">
        <v-card>
          <v-card-text><tape-table admin></tape-table></v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12">
        <v-card>
          <v-card-text><user-table admin></user-table></v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12">
        <v-card>
          <v-card-text><report-table admin></report-table></v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12">
        <v-card>
          <v-card-text><genre-table admin></genre-table></v-card-text>
        </v-card>
      </v-col>
    </v-row>
  </v-container>
